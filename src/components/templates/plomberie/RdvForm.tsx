    ...
    >
      ...
      <fieldset class="mt-10 space-y-5">
        ...
        <div>
          ...
          <input id="bp-adresse" name="adresse" type="text" required autocomplete="street-address"
            ...
            placeholder="12 rue des Lilas, 97430 La Réunion"
      ...
      <div class="mt-10 pt-8 border-t-2 border-bp-anthracite/10">
        ...
        <div class="mt-5 text-center">
          <a href="tel:+262692123456" class="inline-flex items-center gap-2 text-xs font-archivo font-bold uppercase tracking-[0.22em] text-bp-anthracite/65 hover:text-bp-anthracite border-b-2 border-bp-anthracite/20 hover:border-bp-jaune pb-1 transition-colors">
