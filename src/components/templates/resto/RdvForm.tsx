  ...
  return (
    ...
    >
      ...
      <div class="mt-12">
        <button
          type="submit"
          class="w-full inline-flex items-center justify-center gap-3 h-14 px-8 text-sm font-semibold uppercase tracking-[0.22em] font-manrope rounded-full bg-resto-or text-resto-bleu-encre hover:bg-resto-bleu-roi hover:text-resto-blanc-casse transition-colors cursor-pointer"
          style="box-shadow: 0 8px 24px rgb(200 166 94 / 0.45);"
        >
