...
export default {
   ...
   */
  safelist: [
    "bg-lagon-mangue", "bg-lagon-pitaya", "bg-lagon-lime", "bg-lagon-turquoise", "bg-lagon-coco", "bg-lagon-blanc", "bg-lagon-charbon",
    "bg-boost-jaune", "bg-boost-acier", "bg-boost-feu", "bg-boost-noir",
  ],
  theme: {
    extend: {
      colors: {
